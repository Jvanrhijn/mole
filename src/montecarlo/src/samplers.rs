...
where
    T: Function<f64, D = Ix2> + Differentiate + Cache<Array2<f64>, V = Vgl>,
    V: Metropolis<T>,
{
    wave_function: T,
    config: Array2<f64>,
...
where
    T: Function<f64, D = Ix2> + Differentiate + WaveFunction + Cache<Array2<f64>, V = Vgl>,
    V: Metropolis<T>,
...
where
    T: Function<f64, D = Ix2>
        + Differentiate
        + WaveFunction
        + Cache<Array2<f64>, U = usize, V = Vgl>,
    V: Metropolis<T>,
{
